...
import com.example.sanchit.twitterlite.Adapter.customVideosAdapter;
...
public class Videos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserLocalStore userLocalStore = new UserLocalStore(Videos.this);
        ...
        if (largestA == ent)
            url1 = "http://139.59.14.66:5000/entertainmentvideos";
        else if (largestA == sport)
            url1 = "http://139.59.14.66:5000/sportsvideos";
        else if (largestA == pol)
            url1 = "http://139.59.14.66:5000/politicsvideos";
        else if (largestA == tech)
            url1 = "http://139.59.14.66:5000/technologyvideos";
        else if (largestA == bus)
            url1 = "http://139.59.14.66:5000/businessvideos";

        String url2 = "";
        if (largestB == ent)
            url2 = "http://139.59.14.66:5000/entertainmentvideos";
        else if (largestB == sport)
            url2 = "http://139.59.14.66:5000/sportsvideos";
        else if (largestB == pol)
            url2 = "http://139.59.14.66:5000/politicsvideos";
        else if (largestB == tech)
            url2 = "http://139.59.14.66:5000/technologyvideos";
        else if (largestB == bus)
            url2 = "http://139.59.14.66:5000/businessvideos";
        ...
        CustomRequest1 jsObjRequest = new CustomRequest1(Request.Method.GET, url1, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray obj = (JSONArray) response.get("videos");
                    ...
                    try {
                        for (int j = 0; j < obj.length(); j++) {
                            ...
                            e.printStackTrace();
                                    ...
                                    ListAdapter adpt = new customVideosAdapter(Videos.this,list1);
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    ...
                    new Util().showerrormessage(Videos.this, "Time Out Error.....Try Later!!!");

                } else if (error instanceof AuthFailureError) {

                    new Util().showerrormessage(Videos.this, "Authentication Error.....Try Later!!!");
                } else if (error instanceof ServerError) {

                    new Util().showerrormessage(Videos.this, "Server Error.....Try Later!!!");
                } else if (error instanceof NetworkError) {

                    new Util().showerrormessage(Videos.this, "Network Error.....Try Later!!!");
                } else if (error instanceof ParseError) {

                    Log.d("Response: ", error.toString());
                    System.out.println("Response error: " + error.toString());
                    new Util().showerrormessage(Videos.this, "Unknown Error.....Try Later!!!");
                }
            }
        });
        RequestQueue queue = Volley.newRequestQueue(Videos.this);
